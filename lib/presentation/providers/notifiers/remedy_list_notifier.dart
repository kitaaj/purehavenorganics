...
//     ('RemedyListNotifier initialized').log();
//     loadInitial();
//   }

//   Future<void> loadInitial() async {
//     try {
//       ('Loading initial remedies...').log();

//       final remedies = await _repository.getRemedies(params: _currentParams);
//       ('Loaded ${remedies.length} remedies: ${remedies.map((r) => r.name).toList()}')
//           .log();

//       state = AsyncValue.data(remedies);
//     } catch (error, stackTrace) {
//       ('Error loading remedies: $error').log();
