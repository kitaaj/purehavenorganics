...
final remedyCategoriesProvider = FutureProvider<List<RemedyCategory>>((ref) async {
  final dataSource = ref.watch(supabaseDataSourceProvider);
  return dataSource.getCategories();
});

final remedyListProvider = StateNotifierProvider<RemedyListNotifier, AsyncValue<List<Remedy>>>((ref) {
  final repository = ref.watch(remedyRepositoryProvider);
  return RemedyListNotifier(repository);
});

final searchResultsProvider = StateNotifierProvider<SearchNotifier, AsyncValue<SearchState>>((ref) {
